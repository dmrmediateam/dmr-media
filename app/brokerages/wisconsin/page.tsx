...
export const metadata = {
  title: 'Wisconsin Real Estate Brokerages | Top Teams & Firms | DMR Media',
  description: 'Explore Wisconsin\'s top-performing real estate brokerages and teams. From Milwaukee to Green Bay, Lake Geneva to Appleton - discover the state\'s leading firms.',
};

export default function WisconsinBrokeragesPage() {
  const brokerages = getBrokeragesByState('wisconsin');
        ...
        <div className="container-max relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="inline-block px-4 py-2 bg-gold/90 text-off-black font-semibold text-sm uppercase tracking-wider mb-6">
              Wisconsin Brokerages
            </div>
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-serif font-light mb-6 text-white">
              Wisconsin's Top <span className="italic">Real Estate</span> Brokerages
            </h1>
            <p className="text-xl md:text-2xl text-white/90 mb-8 leading-relaxed">
              Discover the Badger State's leading real estate firms and teams dominating markets from Milwaukee to Madison, Green Bay to Lake Geneva.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container-max">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
            <div className="text-center">
              ...
              <div className="text-sm text-gray-400">Top Wisconsin teams</div>
            </div>
            <div className="text-center">
              <div className="text-5xl md:text-6xl font-serif font-light text-gold mb-4">
                4,440+
            ...
            <div className="text-center">
              ...
              <div className="text-lg text-gray-300 mb-2">Annual Volume</div>
              <div className="text-sm text-gray-400">2024 transactions</div>
            </div>
            <div className="text-center">
              <div className="text-5xl md:text-6xl font-serif font-light text-gold mb-4">
                #1
              </div>
              <div className="text-lg text-gray-300 mb-2">State Rankings</div>
              <div className="text-sm text-gray-400">Multiple teams</div>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container-max">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-serif font-light text-off-black mb-4">
              All Wisconsin <span className="italic">Brokerages</span>
            </h2>
            <div className="w-24 h-px bg-off-black mx-auto mb-6"></div>
            <p className="text-gray-dark max-w-2xl mx-auto">
              From tech-driven teams to luxury specialists, explore Wisconsin's most successful real estate brokerages
            </p>
          </div>
                ...
                <div className="p-8">
                  ...
                  <div className="border-t border-gray-200 pt-6">
                    ...
                    <div className="flex gap-4">
                      ...
                      <Link
                        href={`/brokerages/wisconsin/${brokerage.id}`}
      ...
      <section className="section-padding bg-off-black text-off-white">
        <div className="container-max text-center">
          <h2 className="text-4xl md:text-5xl font-serif font-light text-off-white mb-6">
            Ready to <span className="italic">Dominate</span> Wisconsin Real Estate?
          </h2>
          <p className="text-lg text-gray-300 max-w-2xl mx-auto mb-8">
            Join these top-performing Wisconsin brokerages who trust DMR Media for exceptional SEO and digital marketing results.
          </p>
