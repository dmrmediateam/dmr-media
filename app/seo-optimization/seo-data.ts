...
export const websiteExamplesForSeo = [
  ...
  },
  {
    ...
    name: 'Ocean Breeze',
    description:
      'Single-property storytelling for a $6.5M Chalk Sound estate—cinematic visuals, fast UX, and structure buyers (and search) can trust before they ever tour.',
  ...
  },
  {
    ...
    name: 'Valoria Homes',
    description:
      'Custom modular story + conversion paths for Midwest families—design and messaging aligned to how people actually decide.',
...
export const dmrVsAlternatives = [
  ...
  { label: 'Ownership', dmr: 'You approve; we execute—no permission theater', other: 'Ticket queues and surprise billable hours' },
