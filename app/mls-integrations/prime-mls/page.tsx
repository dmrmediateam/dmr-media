...
export const metadata: Metadata = {
  title: 'Prime MLS | iHomeFinder IDX Coverage | New England | DMR Media',
  description:
    'Prime MLS (formerly NEREN) with iHomeFinder IDX coverage. New Hampshire, Vermont, Maine, Massachusetts, Rhode Island, Connecticut. Live listings for New England.',
};

const IDX_VENDORS = ['iHomeFinder'];
const STATES = ['NH', 'VT', 'ME', 'MA', 'RI', 'CT'];

export default function PrimeMlsPage() {
  return (
        ...
        <div className="container-max max-w-3xl space-y-20">
          ...
          <section id="overview">
            ...
            <div className="space-y-6 text-[var(--color-off-black)] font-serif leading-relaxed">
              <div>
                Prime MLS (formerly New England Real Estate Network, or NEREN) is the primary multiple listing service for the New England real estate market. Created through the merger of several regional MLSs, Prime MLS supports over 10,000 real estate professionals across New Hampshire, Vermont, Maine, Massachusetts, Rhode Island, Connecticut, and portions of New York. iHomeFinder provides IDX integration so agents and brokers can display live listings on their websites.
              </div>
              <div>
                ...
                <div>
                  New Hampshire and Vermont—including Manchester, Nashua, Concord, Derry, Dover, Rochester (NH) and Burlington, South Burlington, Colchester, Montpelier, St. Albans (VT). Prime MLS also serves Maine, Massachusetts, Rhode Island, Connecticut, and portions of New York. Cities include Worcester, Boston, Cambridge, Lowell, Portland, and more.
                </div>
              </div>
              <div>
                <h3 className="text-sm uppercase tracking-[0.2em] text-[var(--color-off-black)] mb-3">
                ...
                <div>
                  Licensed agents, brokers, appraisers, assessors, auctioneers, home buyers, and sellers.
                </div>
              </div>
            </div>
          </section>
          ...
          <section id="idx-integration">
            ...
            <div className="space-y-6 text-[var(--color-off-black)] font-serif leading-relaxed">
              <div>
                Prime MLS integrates with iHomeFinder to provide IDX (Internet Data Exchange) services. iHomeFinder connects directly to the MLS feed, allowing agents to display current listings—including active and sold—on their websites with automatic updates approximately every 2 hours.
              </div>
              <div>
                <h3 className="text-lg font-serif font-light text-[var(--color-off-black)] mb-4">
                  iHomeFinder IDX Services for Prime MLS
                </h3>
              ...
              <div>
                ...
                <div>
                  Agents must hold active Prime MLS membership to use iHomeFinder IDX coverage. Display rules and data refresh schedules are set by the MLS. Contact the MLS or iHomeFinder directly for the latest integration requirements.
                </div>
              </div>
              <div>
                <Link
          ...
          <section id="fees">
            ...
            <div className="space-y-6 text-[var(--color-off-black)] font-serif leading-relaxed">
              <div>
                Membership in Prime MLS is required for licensed real estate brokers, appraisers, assessors, and auctioneers who wish to list or show properties in the New England region. Access is obtained through Prime MLS directly.
              </div>
              <div>
                <h3 className="text-lg font-serif font-light text-[var(--color-off-black)] mb-4">
                ...
                <div>
                  None. iHomeFinder does not charge fees paid to the association for Prime MLS IDX coverage.
                </div>
              </div>
              <div>
                iHomeFinder subscription fees for IDX integration are not publicly disclosed. Contact iHomeFinder or the MLS for current pricing and plan options.
              </div>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="space-y-6 text-[var(--color-off-black)] font-serif leading-relaxed">
              <div>
                Prime MLS supports over 10,000 real estate professionals across New England. As the primary MLS for the region, it centralizes listing data from Boston to the shores of Maine, enabling efficient transactions and informed decisions for agents, brokers, and consumers.
              </div>
              <div>
                The Prime MLS footprint covers a wide range of communities—from urban centers like Boston and Worcester to coastal and mountain markets in New Hampshire and Vermont. This breadth helps agents serve buyers and sellers with accurate, up-to-date market information across diverse market segments.
              </div>
              <div>
                Prime MLS operates the public websites primemls.com and commercial.primemls.com, providing members and the public with access to comprehensive property data. The organization focuses on innovation, modern tools, and collaborative support to help members deliver results for their clients.
              </div>
            </div>
          </section>
            ...
            <dl className="space-y-8">
              <div>
                ...
                <dd className="text-[var(--color-off-black)] font-serif leading-relaxed">
                  Prime MLS (formerly New England Real Estate Network, or NEREN) is the primary multiple listing service for New England. It serves New Hampshire, Vermont, Maine, Massachusetts, Rhode Island, Connecticut, and portions of New York, supporting over 10,000 real estate professionals.
                </dd>
              </div>
              <div>
                <dt className="text-lg font-serif font-light text-[var(--color-off-black)] mb-2">
                  Does iHomeFinder support Prime MLS?
                </dt>
                <dd className="text-[var(--color-off-black)] font-serif leading-relaxed">
                  Yes. iHomeFinder is a licensed IDX vendor for Prime MLS. Agents can use iHomeFinder to display active and sold listings on their websites via IDX integration.
                </dd>
              </div>
              <div>
                <dt className="text-lg font-serif font-light text-[var(--color-off-black)] mb-2">
                  What areas does Prime MLS cover?
                </dt>
                <dd className="text-[var(--color-off-black)] font-serif leading-relaxed">
                  New Hampshire, Vermont, Maine, Massachusetts, Rhode Island, Connecticut, and portions of New York. Cities include Manchester, Nashua, Concord, Burlington, Boston, Worcester, Cambridge, Portland, and many more.
                </dd>
              </div>
              <div>
                <dt className="text-lg font-serif font-light text-[var(--color-off-black)] mb-2">
                ...
                <dd className="text-[var(--color-off-black)] font-serif leading-relaxed">
                  You must be an active Prime MLS member. Contact iHomeFinder for IDX subscription options, or work with a web partner who can configure iHomeFinder IDX integration for Prime MLS on your behalf.
                </dd>
              </div>
              <div>
                <dt className="text-lg font-serif font-light text-[var(--color-off-black)] mb-2">
                ...
                <dd className="text-[var(--color-off-black)] font-serif leading-relaxed">
                  Yes. Our team can help you connect your site to Prime MLS. Contact us for assistance with iHomeFinder integration and IDX implementation.
                </dd>
              </div>
            </dl>
          </section>
          ...
          <section className="border-t border-[var(--color-ink-200)] pt-8">
            <h2 className="text-2xl font-serif font-light text-[var(--color-off-black)] mb-6 tracking-tight">
              Connect Your Site to Prime MLS
            </h2>
            <div className="text-[var(--color-off-black)] font-serif leading-relaxed mb-8">
              If you serve the New England market and want to display live listings on your website, iHomeFinder IDX integration for Prime MLS is a proven solution. Our team can help you set up iHomeFinder MLS coverage and ensure your site complies with MLS display rules.
            </div>
            <Link
              href="/contact"
            ...
            >
              ...
              <div className="relative aspect-[16/9] overflow-hidden mb-6">
                <Image
                  ...
                  alt="Willow Brook Realty traffic and lead growth"
                  fill
