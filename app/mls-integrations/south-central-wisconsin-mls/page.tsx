...
export const metadata: Metadata = {
  title: 'South-Central Wisconsin MLS | iHomeFinder IDX Coverage | DMR Media',
  description:
    'South-Central Wisconsin MLS with iHomeFinder IDX coverage. Connect your site to live listings across Dane, Rock, Jefferson & surrounding counties.',
};

const IDX_VENDORS = ['iHomeFinder'];
const STATES = ['WI'];

export default function SouthCentralWisconsinMlsPage() {
  return (
    <div className="min-h-screen bg-white">
      {/* Hero - like [slug] page with integration tags */}
        ...
        <div className="container-max max-w-3xl space-y-20">
          ...
          <section id="about">
            ...
            <dl className="grid grid-cols-1 sm:grid-cols-2 gap-x-12 gap-y-4 text-[var(--color-off-black)] font-serif">
              ...
              <div className="border-b border-[var(--color-ink-200)] pb-3">
                ...
                <dd>$100 set-up fee. $50 quarterly fee for agents. $20 quarterly fee for brokers.</dd>
              </div>
              <div className="border-b border-[var(--color-ink-200)] pb-3">
          ...
          <section id="overview">
            ...
            <div className="space-y-6 text-[var(--color-off-black)] font-serif leading-relaxed">
              <div>
                The South-Central Wisconsin MLS (SCWMLS) serves the greater Madison region and surrounding counties. iHomeFinder provides IDX integration so agents and brokers can display live listings on their websites.
              </div>
              <div>
                ...
                <div>
                  Dane, Rock, Jefferson, Green, Columbia, Sauk, Iowa, Lafayette, and portions of adjacent counties.
                </div>
              </div>
              <div>
                <h3 className="text-sm uppercase tracking-[0.2em] text-[var(--color-off-black)] mb-3">
          ...
          <section id="idx-integration">
            ...
            <div className="space-y-6 text-[var(--color-off-black)] font-serif leading-relaxed">
              <div>
                The South-Central Wisconsin MLS integrates with iHomeFinder to
                provide IDX (Internet Data Exchange) services. iHomeFinder
                connects directly to the MLS feed, allowing agents to display
                current listings on their websites with automatic updates.
              </div>
              <div>
                <h3 className="text-lg font-serif font-light text-[var(--color-off-black)] mb-4">
                  iHomeFinder IDX Services for South-Central Wisconsin MLS
                </h3>
              ...
              <div>
                ...
                <div>
                  Agents must hold active MLS membership to use iHomeFinder MLS
                  coverage. Display rules and data refresh schedules are set by
                  the MLS. Contact the MLS or iHomeFinder directly for the latest
          ...
          <section id="fees">
            ...
            <div className="space-y-6 text-[var(--color-off-black)] font-serif leading-relaxed">
              <div>
                Membership in the South-Central Wisconsin MLS is required for
                agents and brokers who wish to list or show properties in the
                coverage area. Access is typically obtained through a local
                Realtor® association or board.
              </div>
              <div>
                <h3 className="text-lg font-serif font-light text-[var(--color-off-black)] mb-4">
                ...
                <ul className="list-disc list-inside space-y-2">
                  <li>$100 set-up fee</li>
                  <li>$50 quarterly fee for agents</li>
                  <li>$20 quarterly fee for brokers</li>
                </ul>
              </div>
              <div>
          ...
          <section>
            ...
            <div className="space-y-6 text-[var(--color-off-black)] font-serif leading-relaxed">
              <div>
                The South-Central Wisconsin MLS supports real estate
                professionals across the greater Madison region and beyond. It
                centralizes listing data for one of Wisconsin&apos;s most active
                markets, enabling efficient transactions and informed decisions.
              </div>
              <div>
                The MLS south central WI area typically includes thousands of
                active listings across residential, commercial, and land
                segments. This breadth of data helps agents serve buyers and
                sellers with accurate, up-to-date market information.
              </div>
              <div>
                The South-Central Wisconsin MLS focuses specifically on the
                Madison metro and surrounding counties, offering deep local
                coverage for agents who specialize in this region.
              </div>
            </div>
          </section>
            ...
            <dl className="space-y-8">
              <div>
                <dt className="text-lg font-serif font-light text-[var(--color-off-black)] mb-2">
                  What is the South-Central Wisconsin MLS?
                </dt>
                <dd className="text-[var(--color-off-black)] font-serif leading-relaxed">
                  The South-Central Wisconsin MLS is a multiple listing service
                  that aggregates property listings for the greater Madison
                  region and surrounding counties. It serves agents, brokers,
                  buyers, and sellers with centralized listing data.
                </dd>
              </div>
              <div>
                <dt className="text-lg font-serif font-light text-[var(--color-off-black)] mb-2">
                  Does iHomeFinder support the South-Central Wisconsin MLS?
                </dt>
                <dd className="text-[var(--color-off-black)] font-serif leading-relaxed">
                  Yes. iHomeFinder MLS coverage includes the South-Central
                  Wisconsin MLS. Agents can use iHomeFinder to display live
                  listings on their websites via IDX integration.
                </dd>
              </div>
              <div>
                <dt className="text-lg font-serif font-light text-[var(--color-off-black)] mb-2">
                  Which counties does the South-Central Wisconsin MLS cover?
                </dt>
                <dd className="text-[var(--color-off-black)] font-serif leading-relaxed">
                  Coverage includes Dane, Rock, Jefferson, Green, Columbia, Sauk,
                  Iowa, Lafayette, and portions of adjacent counties in
              ...
              <div>
                ...
                <dd className="text-[var(--color-off-black)] font-serif leading-relaxed">
                  You must be an active MLS member. Contact iHomeFinder for IDX
                  subscription options, or work with a web partner who can
                  configure iHomeFinder IDX integration Wisconsin MLS on your
                  behalf.
                </dd>
              </div>
              <div>
                ...
                <dd className="text-[var(--color-off-black)] font-serif leading-relaxed">
                  Yes. Our team can help you connect your site to the
                  South-Central Wisconsin MLS. Contact us for assistance with
                  iHomeFinder integration and IDX implementation.
                </dd>
              </div>
            </dl>
          </section>
          ...
          <section className="border-t border-[var(--color-ink-200)] pt-8">
            <h2 className="text-2xl font-serif font-light text-[var(--color-off-black)] mb-6 tracking-tight">
              Connect Your Site to the South-Central Wisconsin MLS
            </h2>
            <div className="text-[var(--color-off-black)] font-serif leading-relaxed mb-8">
              If you serve the MLS south central WI market and want to display
              live listings on your website, iHomeFinder IDX integration is a
              proven solution. Our team can help you set up iHomeFinder MLS
              coverage for the South-Central Wisconsin MLS and ensure your site
              complies with MLS display rules.
            </div>
            <Link
              href="/contact"
