/** Copy & FAQ schema data for `/landing/google-general` (organic SEO + PPC). */
...
export const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      'Yes. This program is built for teams that want one accountable partner for organic search and paid search: shared intent maps, message match from query to landing page, and CRM-tied reporting so SEO compounds while PPC fills the gap on high-intent days.',
  },
  {
    question: 'How long until we see movement?',
    answer:
      'Paid search can surface qualified conversations within days when tracking and landing paths are correct. Technical SEO and long-tail organic often move first within weeks; competitive head terms compound over quarters. We report weekly on the metrics that matter for each channel.',
  },
  {
    question: 'Do you guarantee #1 rankings for my site?',
    answer:
      'No ethical partner guarantees positions you do not control. What we do guarantee is a disciplined luxury system: clear priorities, accountable execution, and reporting tied to pipeline. Paid and organic reinforce each other so you are not betting the business on a single channel.',
  },
  {
...
export const stakesThree = [
  ...
  {
    title: 'Category',
    subtitle: 'National benchmarks, local outcomes',
    body:
      'Being ranked #1 in the United States on SEMrush signals we compete in the same visibility and auction landscape we manage for clients. The work still maps to your neighborhoods, inventory, and GCI.',
  },
  {
    title: 'Execution',
...
export const processPhases = [
  ...
  },
  {
    title: 'Compound',
    description:
      'Measurement loops tied to leads and listings. Iterate weekly so rankings, creative, and spend reinforce the same pipeline story.',
  },
] as const
...
export const frameworkPillars = [
  ...
  },
  {
    ...
    body:
      'Search and Maps campaigns built for luxury intent: disciplined geography, negatives that protect margin, and landing continuity so spend converts to conversations your CRM recognizes.',
    image: '/images/EaganCaseStudy/SearchAds.png',
    imageAlt: 'Google Ads campaign structure for real estate PPC',
  },
  {
