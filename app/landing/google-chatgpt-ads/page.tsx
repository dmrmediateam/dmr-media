...
export default function GoogleChatGPTAdsLandingPage() {
    ...
    <>
      ...
      >
        ...
        >
          ...
          <div className="relative z-10 w-full px-4 sm:px-6 md:px-8 lg:px-12 max-w-7xl mx-auto pt-20 sm:pt-24">
            <div className="max-w-2xl lg:max-w-3xl">
              ...
              >
                ...
                <em className="not-italic font-normal">About 18 Months</em>
              </motion.h1>
              ...
              >
                ChatGPT and Google AI are starting to recommend agents directly in answers—before users click a single website. This isn&apos;t another ad channel. It&apos;s the first time you can appear inside AI. Early positioning matters.
              </motion.p>
              ...
              >
                Limited onboarding · Evaluation for fit · 15 minutes
              </motion.p>
            </div>
          </div>
          ...
          >
            <motion.button
              onClick={() => document.getElementById('market-shift')?.scrollIntoView({ behavior: 'smooth' })}
              animate={{ y: [0, 8, 0] }}
        ...
        >
          <div className="max-w-4xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
            <p className="text-base sm:text-lg font-serif text-[var(--color-off-black)] text-center sm:text-left">
              Ready to evaluate early access?
            </p>
            <motion.button
              onClick={scrollToBook}
          ...
          <div className="container-max max-w-3xl mx-auto">
            ...
            >
              ...
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-serif font-light text-[var(--color-off-black)] leading-[1.15] tracking-tight">
                Search behavior is moving from links to answers.
              </h2>
              <p className="text-base sm:text-lg font-serif text-[var(--color-ink-300)] leading-relaxed">
                For decades, a search query returned a list of links. Users chose where to click. SEO and Google Ads put you on that list. The goal was to get the click.
              </p>
              <p className="text-base sm:text-lg font-serif text-[var(--color-ink-300)] leading-relaxed">
                Now ChatGPT and Google&apos;s AI Overview answer the question directly. They cite sources. They recommend providers by name. The user gets an answer—often without clicking any website. The agents and brokerages that appear in those answers gain visibility before the click. Everyone else competes for what&apos;s left.
              </p>
              <p className="text-base sm:text-lg font-serif text-[var(--color-off-black)] font-light">
                This isn&apos;t another ad channel. It&apos;s the first time agents can be embedded inside AI answers. The placement matters.
              </p>
            </motion.div>
          </div>
        </section>
        ...
        <section className="py-16 sm:py-20 md:py-28 px-4 sm:px-6 bg-white">
          <div className="container-max max-w-3xl mx-auto">
            ...
            >
              ...
              <p className="text-base sm:text-lg font-serif text-[var(--color-ink-300)] leading-relaxed">
                Early Zillow Premier Agent advertisers paid a fraction of what agents pay today. They dominated listing visibility in their markets for years. The agents who joined later paid more, got less, and never caught up.
              </p>
              <p className="text-base sm:text-lg font-serif text-[var(--color-ink-300)] leading-relaxed">
                Early Google Ads adopters in real estate secured the best keywords at the lowest costs. By the time everyone else arrived, CPCs had tripled and competition had saturated the auctions.
              </p>
              <p className="text-base sm:text-lg font-serif text-[var(--color-ink-300)] leading-relaxed">
                Early SEO adopters built domain authority that compounds to this day. Late adopters are still trying to outrank them—often at far higher effort and cost.
              </p>
              <p className="text-base sm:text-lg font-serif text-[var(--color-off-black)] font-light">
                The pattern is consistent: early entrants lock in position and cost. Late entrants pay more for less and spend years catching up. Sometimes they never do.
              </p>
            </motion.div>
          </div>
        </section>
        ...
        <section className="py-16 sm:py-20 md:py-28 px-4 sm:px-6 bg-[var(--surface-base)]">
          <div className="container-max max-w-3xl mx-auto">
            ...
            >
              <h2 className="text-xl sm:text-2xl md:text-3xl font-serif font-light text-[var(--color-off-black)] leading-tight">
                The coming problem for late adopters
              </h2>
              <p className="text-base sm:text-lg font-serif text-[var(--color-ink-300)] leading-relaxed">
                Once AI answers start recommending specific agents, the agents who are embedded first gain a structural advantage. They&apos;re cited. They&apos;re named. They appear when buyers and sellers ask before they ever click.
              </p>
              <p className="text-base sm:text-lg font-serif text-[var(--color-ink-300)] leading-relaxed">
                Late adopters won&apos;t just face higher costs. They&apos;ll compete against agents who are already in the answer. The position becomes locked. AI models are trained on existing patterns—early signals compound. Catching up later is exponentially harder.
              </p>
            </motion.div>
          </div>
        </section>
        ...
        {/* ═══════════════════════════════════════════════════════════════
            UNIQUE MECHANISM - AI Placement Layer
            ═══════════════════════════════════════════════════════════════ */}
        <section id="ai-placement" className="py-16 sm:py-20 md:py-28 px-4 sm:px-6 bg-white">
          <div className="container-max max-w-3xl mx-auto">
            <motion.div
              initial={{ opacity: 0, y: 24 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              ...
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-serif font-light text-[var(--color-off-black)] leading-tight">
                The <em className="not-italic font-normal text-[var(--color-trust)]">AI Placement Layer</em>
              </h2>
              <p className="text-base sm:text-lg font-serif text-[var(--color-ink-300)] leading-relaxed">
                Agents are positioned where ChatGPT and Google AI generate recommendations—not where users click. Your presence is structured so that when a buyer or seller asks &quot;Who are the best agents in [your market]?&quot; or &quot;Who should I contact for luxury listings?&quot; you appear in the answer.
              </p>
              <p className="text-base sm:text-lg font-serif text-[var(--color-ink-300)] leading-relaxed">
                This isn&apos;t about outbidding someone on a click. It&apos;s about being <em>citable</em>. AI models look for clear signals: expertise, authority, relevance. The AI Placement Layer is the underlying structure that makes you recommendable—before anyone clicks a link.
              </p>
              <p className="text-base sm:text-lg font-serif text-[var(--color-off-black)] font-light">
                You show up in the answer. Not just in the search results.
              </p>
            </motion.div>
          </div>
        </section>
        ...
        <section className="py-16 sm:py-20 md:py-28 px-4 sm:px-6 bg-[var(--surface-base)]">
          <div className="container-max max-w-3xl mx-auto">
            ...
            >
              ...
              <h2 className="text-xl sm:text-2xl md:text-3xl font-serif font-light text-[var(--color-off-black)] leading-tight">
                Google. Search behavior. Real estate intent.
              </h2>
              <p className="text-base sm:text-lg font-serif text-[var(--color-ink-300)] leading-relaxed">
                We specialize in how Google and AI systems interpret real estate intent. Not generic marketing. Not social media. Specifically: how search behavior is changing, how AI answers are generated, and what signals make an agent recommendable in those contexts.
              </p>
              <p className="text-base sm:text-lg font-serif text-[var(--color-ink-300)] leading-relaxed">
                We&apos;ve been building for Google Ads and SEO in luxury real estate since 2022. We understand how agents get found, how traffic converts, and how to position for the next phase—where AI recommends providers before users click.
              </p>
            </motion.div>
          </div>
        </section>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-10">
                <div className="p-6 sm:p-8 bg-[var(--surface-base)] border border-[var(--color-ink-200)]">
                  ...
                  <p className="text-sm sm:text-base font-serif text-[var(--color-ink-300)] leading-relaxed">
                    You build your AI Placement Layer now. When recommendation rolls out more broadly, you&apos;re already embedded. Inbound authority compounds. You appear when buyers and sellers ask. The cost to acquire that presence stays low because you moved before the market saturated.
                  </p>
                </div>
                <div className="p-6 sm:p-8 bg-[var(--color-off-black)] border border-[var(--color-off-black)]">
                  ...
                  <p className="text-sm sm:text-base font-serif text-white/80 leading-relaxed">
                    You wait until AI recommendations are mainstream. By then, competitors in your market are already in the answers. Cost has risen. Position is crowded. You spend more to achieve less—and you&apos;re permanently catching up.
                  </p>
                </div>
              </div>
            </motion.div>
          ...
          <div className="container-max max-w-2xl mx-auto text-center">
            ...
            >
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-serif font-light !text-white mb-6 leading-tight">
                The rollout is underway. Request your audit before the window narrows.
              </h2>
              <motion.button
                onClick={scrollToBook}
