...
const STEPS = [
  ...
  },
  {
    ...
    body:
      'Use the add-to-calendar link in that email so September 16th at 12pm ET / 9am PT is locked in. Attendance is the whole game — the offer below is live-only.',
  },
  {
    title: 'Show up live',
    body:
      'Live attendees unlock the FREE website offer (*additional purchase required) and get their questions answered on air. No replay for the offer.',
  },
] as const;

function ThankYouWebinarContent() {
        ...
        <div className="mx-auto max-w-2xl text-center">
          <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
            ...
            <h1 className="mb-5 font-serif text-3xl font-light leading-[1.1] tracking-tight text-[var(--color-off-black)] sm:text-4xl md:text-5xl">
              {firstName ? `${firstName}, your` : 'Your'} seat is saved
          ...
          >
            ...
            <p className="mt-2 font-serif text-xs text-[var(--color-ink-400)]/80">*Additional purchase required.</p>
          </motion.div>
        </div>
      </section>
    </div>
...
export default function ThankYouWebinarPage() {
  return (
    <Suspense
      fallback={
