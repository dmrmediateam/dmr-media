        ...
        <div className="relative z-10 container-max flex min-h-screen items-center justify-center py-20 text-center pointer-events-none">
          ...
          >
            ...
            <p className="mx-auto mt-8 max-w-3xl font-serif text-lg leading-relaxed text-white/90 sm:text-xl">
              We engineer inbound systems: search visibility, disciplined Google Ads, landing and form UX, and
              follow-up velocity your CRM can measure. One accountable team so spend, capture, and nurture tell the same
              story.
            </p>
            <p className="mx-auto mt-4 max-w-3xl font-serif text-sm leading-relaxed text-white/75 sm:text-base">
              Documented lifts include 46+ qualified inbound leads in three weeks and 3× qualified pipeline in ninety
              days when the full spine is live—exclusive to your brand, not shared lists.
            </p>
            <div className="mt-10 flex flex-col items-center gap-4">
              ...
              <Link
                href="/calendar"
                className="font-serif text-[11px] uppercase tracking-[0.18em] text-white/70 underline-offset-4 transition-colors hover:text-white/95 hover:underline"
              >
              ...
              <motion.a
                ...
                className="mt-6 inline-flex rounded-sm p-1 text-white/35 outline-none transition-colors hover:text-white/55 focus-visible:ring-2 focus-visible:ring-white/50 focus-visible:ring-offset-2 focus-visible:ring-offset-[#0a0a0a]"
            ...
            stats={[
              {
                ...
                description: 'Per month average patterns when acquisition, capture, and CRM align in documented programs.',
              },
              {
                value: '3×',
                label: 'Qualified volume',
                description: 'Lift vs. prior systems when search, paid, landing, and automation ship as one spine.',
              },
              {
                value: '2–3×',
                label: 'Lower cost per lead',
                description: 'Vs. many portal and shared-list setups—measured on conversations your team recognizes as real.',
              },
            ]}
          />
        </div>
