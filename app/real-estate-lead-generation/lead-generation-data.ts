/** Shared copy & structured data for `/real-estate-lead-generation` (server + client). */
...
export const stakesThree = [
  ...
  {
    title: 'Velocity',
    subtitle: 'The five-minute window',
    body:
      'Luxury buyers expect the same responsiveness they get from every other premium service. Slow routing, generic nurture, and forms that fight mobile quietly train high-intent people to choose whoever answers like a guide, not a queue.',
  },
  {
    title: 'Ownership',
    subtitle: 'Renting the first conversation',
    body:
      'If you do not own search, landing, and CRM signals in one system, you cannot tune spend to GCI. The invisible cost is not “bad leads.” It is conversations you never see because the right buyer searched and met a competitor’s story first.',
  },
] as const
...
export const dmrVsAlternatives = [
  {
    label: 'Strategy',
    dmr: 'Intent maps across SEO, Ads, and capture tied to the conversations you want on calendar',
    other: 'Single-channel fixes or generic “lead gen” packages',
  },
  {
    label: 'Execution',
    dmr: 'Weekly shipping: creative, landing paths, negatives, and nurture in one accountable rhythm',
    other: 'Quarterly decks with little change to routing or message match',
  },
  {
    label: 'Ownership',
    dmr: 'You approve major moves; we own instrumentation and iteration with plain-language reporting',
    other: 'Black-box dashboards and surprise billable hours for basic edits',
  },
  {
    label: 'Proof',
    dmr: 'Qualified leads, speed-to-lead, and CRM outcomes documented in flagship engagements',
    other: 'Click volume and screenshots without pipeline context',
  },
  {
    label: 'Integration',
    dmr: 'Demand, capture, and automation from one team when you want the full stack',
    other: 'Fragmented vendors whose incentives fight in your CRM',
  },
] as const
...
export const processPhases = [
  ...
  {
    title: 'Launch and calibrate spend',
    description:
      'Google Ads and organic programs paced together: paid fills the gap while SEO compounds; negatives and audiences tighten weekly against qualified outcomes.',
  },
  {
