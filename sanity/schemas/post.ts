      ...
      fields: [
        {
          ...
          description: 'Describe the image for screen readers and Google Image Search — use the target keyword naturally.',
          validation: (Rule) => Rule.required(),
        },
        {
          name: 'caption',
          ...
          description: 'Appears in metadata and future display. Helps Google understand image context.',
        },
      ],
      validation: (Rule) => Rule.required(),
    }),
